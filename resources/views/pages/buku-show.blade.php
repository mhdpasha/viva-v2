        ...
        <a id="back" class="btn btn-dark" href="{{ URL::previous() }}">
            < </a>
                ...
                <div>
                    ...
                    <p style="max-width: 600px">{{ $buku->deskripsi }}</p>

                    <h5>Detail Buku</h5>
                    <ul>
                        <li>Kategori : <span
                                class="p-2 badge bg-{{ $buku->kategori->status == 'aktif' ? 'success' : 'danger' }}">{{ $buku->kategori->kode }}</span>
                        </li>
                        ...
                        <tbody>
                            @foreach ($stok as $detail)
                                <tr>
                                    ...
                                    <td>{{ Str::limit($detail->serial_num, 13) }}</td>
                                    <td>
